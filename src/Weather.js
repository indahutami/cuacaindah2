...
constructor(props) {
  ...
  try {
    let response = await fetch(
      'http://api.openweathermap.org/data/2.5/weather?q='+ this.state.city + '&appid=4f6c63e2556f5d247266e29abc5e6097&units=metric'
    );
  ...
  render() {
    ...
    <View style={styles.containerMain}>
      <View style={styles.box2}>
          ...
          <TextInput
                style={{ height: 40, color: 'blue', padding: 9}}
              placeholder="  "
